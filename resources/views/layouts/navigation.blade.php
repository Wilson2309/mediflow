@php
    ...
    $icons = [
        ...
        'dailyAgenda' => '<svg class="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" d="M7.5 3.75v3M16.5 3.75v3M4.5 9.75h15M6.75 6h10.5a2.25 2.25 0 0 1 2.25 2.25V18a2.25 2.25 0 0 1-2.25 2.25H6.75A2.25 2.25 0 0 1 4.5 18V8.25A2.25 2.25 0 0 1 6.75 6ZM8.25 13.5h3M8.25 16.5h5.25M15 13.5h.01" /></svg>',
        ...
        'audit' => '<svg class="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" d="M12 3.75 19.5 7.5v5.25c0 4.1-2.7 7.75-7.5 8.5-4.8-.75-7.5-4.4-7.5-8.5V7.5L12 3.75ZM9 12.25l2 2 4-4.5M8.25 7.5h7.5" /></svg>',
    ...
    $moduleLinks = [
        ...
        ['label' => 'Agenda del dia', 'href' => route('daily-agenda.index'), 'active' => request()->routeIs('daily-agenda.*'), 'icon' => 'dailyAgenda', 'permission' => 'appointments.view'],
