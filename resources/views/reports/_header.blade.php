...
<section class="space-y-5">
    <div class="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        ...
        @elseif (request()->routeIs('reports.appointments') && auth()->user()?->can('reports.appointments'))
            <div class="flex flex-wrap gap-2">
                <a href="{{ route('reports.appointments.export.pdf', $financialQuery) }}" class="rounded-lg border border-[#E2E8F0] bg-white px-3 py-2 text-xs font-semibold text-[#0F172A] transition hover:border-[#2563EB] hover:text-[#2563EB]">Exportar PDF</a>
                <a href="{{ route('reports.appointments.export.csv', $financialQuery) }}" class="rounded-lg border border-[#E2E8F0] bg-white px-3 py-2 text-xs font-semibold text-[#0F172A] transition hover:border-[#2563EB] hover:text-[#2563EB]">Exportar CSV</a>
                <a href="{{ route('reports.appointments.export.xlsx', $financialQuery) }}" class="rounded-lg border border-[#E2E8F0] bg-white px-3 py-2 text-xs font-semibold text-[#047857] transition hover:border-[#10B981] hover:text-[#047857]">Exportar Excel</a>
                <a href="{{ route('reports.appointments.print', $financialQuery) }}" class="rounded-lg bg-[#0F172A] px-3 py-2 text-xs font-semibold text-white transition hover:bg-slate-800">Imprimir</a>
            </div>
        @elseif (request()->routeIs('reports.clinical') && auth()->user()?->can('reports.clinical'))
            <div class="flex flex-wrap gap-2">
                <a href="{{ route('reports.clinical.export.pdf', $financialQuery) }}" class="rounded-lg border border-[#E2E8F0] bg-white px-3 py-2 text-xs font-semibold text-[#0F172A] transition hover:border-[#2563EB] hover:text-[#2563EB]">Exportar PDF</a>
                <a href="{{ route('reports.clinical.export.csv', $financialQuery) }}" class="rounded-lg border border-[#E2E8F0] bg-white px-3 py-2 text-xs font-semibold text-[#0F172A] transition hover:border-[#2563EB] hover:text-[#2563EB]">Exportar CSV</a>
                <a href="{{ route('reports.clinical.export.xlsx', $financialQuery) }}" class="rounded-lg border border-[#E2E8F0] bg-white px-3 py-2 text-xs font-semibold text-[#047857] transition hover:border-[#10B981] hover:text-[#047857]">Exportar Excel</a>
                <a href="{{ route('reports.clinical.print', $financialQuery) }}" class="rounded-lg bg-[#0F172A] px-3 py-2 text-xs font-semibold text-white transition hover:bg-slate-800">Imprimir</a>
            </div>
        @endif
    </div>
