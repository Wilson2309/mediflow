<x-app-layout>
    <div class="space-y-6">
        ...
        <form method="POST" action="{{ route('prescriptions.store') }}" class="overflow-hidden rounded-lg border border-[#E2E8F0] bg-white shadow-sm" data-offline-draft="true" data-draft-form="prescriptions" data-draft-record="new" data-offline-draft-message="No hay conexión. El contenido fue guardado como borrador local. Revísalo y envíalo cuando vuelva la conexión.">
            @csrf
